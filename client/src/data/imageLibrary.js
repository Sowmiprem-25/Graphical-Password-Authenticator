...
export const getImageById = (id) => IMAGE_LIBRARY.find((img) => img.id === id);

// Helper: get N random images from pool, excluding given IDs
export const getRandomImages = (count, excludeIds = []) => {
...
export const getCueImageOptions = (count = 6, correctId = null, globalExcludeIds = []) => {
...
export const getDecoyImages = (count, correctImageIds = []) => {
...
export const buildLoginGrid = (correctImageIds = []) => {
